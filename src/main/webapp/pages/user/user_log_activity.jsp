...
<t:page title="User Page | Edit">
    ...
    <jsp:body>
        ...
        <div class="container-fluid">
            <div class="row">
                <t:user-nav currentPage="log-activity" />
                <main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
                    <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
                        <h1 class="h2">User Log Activity</h1>
                    ...
                    <form method="post" action="log_new_activity_user.command">
                        ...
                        <br>
                        <button type="submit" class="btn-primary" formaction="log_new_activity_user.command">Log New</button>
                        <button formaction="index.command" class="btn-primary" method="get" formnovalidate>Cancel</button>
                    </form>
                </main>
            </div>
        </div>
